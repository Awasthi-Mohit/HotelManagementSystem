...
namespace HotelManagementSystemUser.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
            ...
            IEmailSender emailSender)
        {
            ...
            Countries = _dbContext.Countrys.ToList();
            States = _dbContext.States.ToList();
            Cities = _dbContext.Citys.ToList();
        ...
        public class InputModel
        {
            ...
            [MaxLength(16, ErrorMessage = "Phone number cannot be more than  characters.")]
          
            [Display(Name = "Phone Number")]

            public string PhoneNumber { get; set; }
            [Display(Name = "Postal Code")]
            [MaxLength(10, ErrorMessage = "postal code number cannot be more than 10 characters.")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            // List of external authentication schemes (if any)
            ExternalLogins = (await _signInManager.GetExternalAuthenticationSchemesAsync()).ToList();

            if (ModelState.IsValid) // Ensure model state is valid  
            {
                // Create a new user with registration information
            ...
            // If validation fails or user creation fails, re-display the registration page
            return Page();
        }
...

        {
            ...
            var userExists = _userManager.Users.Any(u => u.Email == email);
